...
! function(t, e) {
  ...
  const t = {
      ...
      c = (t, e) => {
          let i = !1;
          const n = e + 5;t.addEventListener("transitionend", (function e() {
  ...
  H.on(document, "click.bs.button.data-api", '[data-bs-toggle="button"]', t => {
      ...
      let i = w.get(e, "bs.button");i || (i = new W(e)),
      i.toggle()
  }), b(W);
  const U = {
          ...
          getDataAttributes(t) {
              ...
              return Object.keys(t.dataset).filter(t => t.startsWith("bs")).forEach(i => {
                  let n = i.replace(/^bs/, "");n = n.charAt(0).toLowerCase() + n.slice(1, n.length),
                  e[n] = q(t.dataset[i])
              }), e
          },
  ...
  class Q extends R {
      ...
      _addTouchEventListeners() {
          const e = t => {!this._pointerEvent || "pen" !== t.pointerType && "touch" !== t.pointerType ? this._pointerEvent || (this.touchStartX = t.touches[0].clientX) : this.touchStartX = t.clientX
              ...
              n = t => {!this._pointerEvent || "pen" !== t.pointerType && "touch" !== t.pointerType || (this.touchDeltaX = t.clientX - this.touchStartX),
                  this._handleSwipe(),
  ...
  H.on(document, "click.bs.collapse.data-api", '[data-bs-toggle="collapse"]', (function(e) {
      ...
      t.find(s).forEach(t => {
          ...
          let n;e ? (null === e._parent && "string" == typeof i.parent && (e._config.parent = i.parent, e._parent = e._getParent()), n = "toggle") : n = i,
  ...
  const Ee = () => {
      ...
      Ae = () => {
          const t = document.body.style.overflow;t && U.setDataAttribute(document.body, "overflow", t),
      ...
      Le = (e, i, n) => {
          const s = Ee();t.find(e).forEach(t => {
              ...
              const e = t.style[i],
                  o = window.getComputedStyle(t)[i];U.setDataAttribute(t, i, e),
