...
(function() {
    ...
    l(function() {
        ...
        if (r) h(document).on("add.cards changeParameter.cards", function(c) {
                ...
                var a = function() {
                        ...
                        g.forEach(function(e) {
                            var f = e.offsetHeight,
                                g = d(e);
                            (g + f >= a && g - 50 <= c || b(e)) && e.classList.contains("hidden") && (e.classList.remove("hidden"), e.classList.add("animate__fadeInUp"), e.classList.add("animate__delay-1s"), e.addEventListener("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
            ...
            var a = function(a) {
                ...
                b = function(b) {
                    ...
                    h.addEventListener("click", function() {
                        -1 !== e.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"); - 1 !== e.indexOf("vimeo") && d.pause();
